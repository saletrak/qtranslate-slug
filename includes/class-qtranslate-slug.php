...
class QtranslateSlug {
	...
	private function get_lang() {
		if($this->force_lang) return $this->force_lang;
		return ($this->lang) ? $this->lang : $this->current_lang;
	}

	public function set_force_lang($lang) {
		$this->force_lang = $lang;
	}
	...
	public function get_meta_key($force_lang = false) {
		...
		if($this->force_lang) $lang = $this->force_lang;
